  ...
  return (
    <div style={{
      ...
      <form onSubmit={submit} style={{
        ...
        <h2 style={{ margin: '0 0 6px', fontSize: 18 }}>注册</h2>
        ...
        <label style={{ display: 'block', fontSize: 12, color: 'var(--text-muted)', marginBottom: 4 }}>显示名（可选）</label>
        <input value={display} onChange={(e) => setDisplay(e.target.value)} maxLength={80}
               style={{ width: '100%', padding: '8px 10px', border: '1px solid var(--border)', borderRadius: 6, marginBottom: 12 }} />

        <label style={{ display: 'block', fontSize: 12, color: 'var(--text-muted)', marginBottom: 4 }}>邮箱（可选）</label>
        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} maxLength={200}
               style={{ width: '100%', padding: '8px 10px', border: '1px solid var(--border)', borderRadius: 6, marginBottom: 12 }} />

        <label style={{ display: 'block', fontSize: 12, color: 'var(--text-muted)', marginBottom: 4 }}>密码（至少 6 位）</label>
        <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6}
               style={{ width: '100%', padding: '8px 10px', border: '1px solid var(--border)', borderRadius: 6, marginBottom: 12 }} />

        <label style={{ display: 'block', fontSize: 12, color: 'var(--text-muted)', marginBottom: 4 }}>确认密码</label>
